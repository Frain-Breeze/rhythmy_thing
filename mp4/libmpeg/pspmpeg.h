...
SceInt32 sceMpegGetAvcNalAu(SceMpeg* _mpeg, Mp4AvcNalStruct* _nal, SceMpegAu* _mpeg_au);
SceInt32 sceMpegAvcDecodeDetail2(SceMpeg* _mpeg, Mp4AvcDetail2Struct** _mpeg_detail2);
SceInt32 sceMpegBaseCscAvc(uint8_t* _buf, ScePVoid _loli, SceInt32 _loli2, Mp4AvcCscStruct* _csc);*/
